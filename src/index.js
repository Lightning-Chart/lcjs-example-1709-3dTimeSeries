...
const { lightningChart, AxisTickStrategies, PalettedFill, LUT, ColorCSS, PointStyle3D, Themes } = lcjs
...
fetch(document.head.baseURI + 'examples/assets/1709/waterlooplace_airquality.json')
    ...
    .then((data) => {
        ...
        chart3D.axisX.setTickStrategy(AxisTickStrategies.DateTime, (strategy) => strategy.setDateOrigin(dateOrigin))
